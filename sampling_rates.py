...
class PFAS_DATA:
    ...
    def __init__(self):
        ...
        pfas_data.loc[18, :] = ['L-PFHxS', 400.12, 178.37, 6, 'SO3H', 9.8, 2.28e-13, 5.58, 0.10, 5.46e-6]
        pfas_data.loc[19, :] = ['Br-PFHxS', 400.12, 178.37, 6, 'SO3H', 9.8, 2.28e-13, 5.58, 0.10, 5.46e-6]
        pfas_data.loc[20, :] = ['PFHpS', 450.12, 200.00, 7, 'SO3H', 8.2, np.nan, 6.26, 0.18, 5.33e-6]
        pfas_data.loc[21, :] = ['L-PFOS', 500.12, 221.63, 8, 'SO3H', 12.1, 6.42e-14, 6.16, 0.08, 5.27e-6]
        pfas_data.loc[22, :] = ['Br-PFOS', 500.12, 221.63, 8, 'SO3H', 12.1, 6.42e-14, 6.16, 0.08, 5.27e-6]
